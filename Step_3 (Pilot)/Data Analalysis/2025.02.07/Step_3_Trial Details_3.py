...
def main():
    ...
    timing_file = base_path / "Timing_analysis/trial_timing_analysis_20250207_132318.csv"
    behavioral_file = base_path / "Raw Data/Behavioral-Task Data/Elmira-ses001-run1-20250131-185646.csv"
    # rl_model_file = base_path / "1-Behavioral Data Analysis/RL Model Fitting/rl_model_results/Elmira_rl_model_results_185646.json"
    rl_model_file = base_path / "1-Behavioral Data Analysis/RL Model Fitting/model_comparison_results/Elmira_rl_model_results_185646.json"
    ...
    # Save text log
    txt_output = base_path / "Timing_analysis/trial_timing_log_with_removed.txt"
    save_timing_log(trial_timings, removed_trials, txt_output)

    # Save Excel file
    excel_output = base_path / "Timing_analysis/trial_timing_data_cleaned.xlsx"
