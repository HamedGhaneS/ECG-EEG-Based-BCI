...
def main():
    ...
    behavioral_file = base_path / "Harry-ses001-run1-20250114-130445.csv"
    timing_pairs_file = base_path / "Harry-ses001-run1-20250114-130445_timing_pairs.csv"
    
    # Create output directory in current working directory
    output_dir = Path.cwd() / "timing_analysis"
