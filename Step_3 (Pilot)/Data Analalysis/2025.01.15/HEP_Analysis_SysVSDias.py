...
def main():
    ...
    # Define channel groups
    channel_groups = {
    'Frontocentral': [3, 4, 5, 8, 9, 12, 13, 14],  # Zero-based indexing for F3,Fz,F4,FC1,FC2,C3,Cz,C4
    'Centroparietal': [12, 13, 14, 18, 19, 23, 24, 25]  # Zero-based indexing for C3,Cz,C4,CP1,CP2,P3,Pz,P4
    }
