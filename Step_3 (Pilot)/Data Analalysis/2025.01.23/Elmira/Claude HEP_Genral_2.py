...
# Updated base path
base_path = r"H:\Post\6th_Phase (ECG-EEG Baced BCI)\2025.01.23\Pilot Data Analysis\Elmira\Epoching"
...
def main():
    ...
    for condition_name, condition_info in analysis_conditions.items():
        ...
        # Save figures
        fig1.savefig(os.path.join(base_path, f'{condition_name}_combined_hep_analysis.png'), dpi=300, bbox_inches='tight')
        fig2.savefig(os.path.join(base_path, f'{condition_name}_individual_peaks_analysis.png'), dpi=300, bbox_inches='tight')
