...
def create_marker_outlet():
    info = StreamInfo(
        name='R_PEAK',           # Changed from 'ECG_R_Peak_Markers' to 'R_PEAK'
        type='Markers',
        channel_count=1,
        nominal_srate=0,
...
def process_ecg_stream():
    ...
    USE_SIMULATION = False  # Set to False to use real BrainVision stream
    ...
    try:
        ...
        print("Marker stream created: R_PEAK")  # Updated to match the actual stream name
